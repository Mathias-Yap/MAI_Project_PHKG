...
if __name__ == "__main__":
    ...
    question_store = QuestionTemplateVectorStore(file_name = "/home/mathiasyap/Code/university/phkg/MAI_Project_PHKG/src/vector_stores/questions.index/qq_index.faiss")
