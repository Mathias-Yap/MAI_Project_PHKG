...
"""pipeline component for gpt-4o-mini
This class provides a simple interface for interacting with the gpt-4o-mini language model.
Returns:
...
class gpt_pipeline:
    def __init__(
        self, model_string: str, max_length: int = 500, temperature: float = 0.3
    ):
        openai_key = ""
    ...
    def generate(self, prompt, system_prompt):
        ...
        with get_openai_callback() as cb:
            ...
            self.requests += 1
            print(f"Cost (USD): ${format(cb.total_cost, '.6f')}")
