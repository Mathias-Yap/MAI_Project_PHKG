...
sample_size = 400
rdf_path = f"/Users/annamayer/Documents/mycode/ResearchProject2/mnt/data/rdf_{sample_size}_sphn.txt"
output_dir = f"/Users/annamayer/Documents/mycode/ResearchProject2/mnt/data/sparql_queries_shape_compl_one/size_{sample_size}/"
    ...
    for _, _, lab_result in g.triples((lab_event, has_labtest, None)):
        for _, _, code in g.triples((lab_result, has_code, None)):
            ...
            sparql = f"""PREFIX sphn: <{NS}>
                SELECT ?code WHERE {{
                <{lab_event_str}>   sphn:hasLabTest ?labResult .
